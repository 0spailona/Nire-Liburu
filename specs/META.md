...
> **Bootstrap state:** this spec system was initialized before any application code existed in this repository. No architecture, domain, or contract specs have been generated — they must be derived from actual code (see [Bootstrap Phase](WORKFLOW.md#2-bootstrap-phase)). Remove this notice once the first code-derived specs exist.
...
6. **Derive from code, don't invent** — every claim in a spec must be traceable to actual code in this repository. Unverified statements are marked `<!-- TODO: verify -->`.
